/*
  ...
  This example only transmits one ZE package per pass. A later example illustrates how to transmit multiple packages on each pass (90 seconds apart).
...
void loop()
{
  ...
  switch (loop_step) {
    ...
    case calculate_next_pass:
    {
      ...
      float min_elevation = 45.0; // Minimum satellite elevation (above the horizon) - *** reduce this to perhaps 5 or 15 degrees if you have a clear view to the horizon ***
